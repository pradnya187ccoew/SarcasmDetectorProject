...
#model.add(BatchNormalization(axis=-1, momentum=0.99, epsilon=0.001, center=True, scale=True, beta_initializer='zeros', gamma_initializer='ones', moving_mean_initializer='zeros', moving_variance_initializer='ones', beta_regularizer=None, gamma_regularizer=None, beta_constraint=None, gamma_constraint=None))
model.add(Dropout(0.35))
model.add(Dense(2,activation='sigmoid')) #here 2 becuase of label tensor shape
...
checkpoint = ModelCheckpoint(filepath="model_lstm_emoji_word.h5", monitor='val_acc', verbose=1, save_best_only=True, mode='max')
...
plot.savefig('lstm_emoji_word.png')
plot.show()
...
with open("model_lstm_emoji_word.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model_lstm_emoji_word.h5")
